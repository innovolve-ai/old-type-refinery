...
const render = (d3_local_graph, local_svg, theme) => {
  console.log('my svg is -> ', local_svg)
    // Setup Basic Variables
    const d3nodes = d3_local_graph.basic.nodes;
    const d3edges = d3_local_graph.basic.links;
    //const gTypes = JSON.parse(JSON.stringify(d3_local_graph.details));
