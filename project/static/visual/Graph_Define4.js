    ...
    function graph_define(graph, local_screen_svg, theme) {
        ...
        var linkmerge = link.enter().append("line")
            .attr("class", "link")
            .style("stroke-width", theme.edges.stroke)
        ...
        function getLabelText(d) {
            ...
            switch(loc_type) {
                case 'attribute':                                
                    ...
                    if ((theme.attribute.label_name == true) & (theme.attribute.label_value == true)) {
                        loc_str = loc_str + ': '
                    }
                    ...
                    if (d.dtype == 'actual'){
                        d.tcolour = theme.attribute.tcolour
                    } else {
                        d.tcolour = theme.shadow.tcolour
                    }         
                    d.tsize = theme.attribute.tsize            
                    d.split = theme.attribute.split_line
                    d.label = loc_str
                    break;
                ...
                case 'entity':
                    ...
                    if ((theme.entity.label_name == true) & (theme.entity.label_iid == true)) {
                        loc_str = loc_str + ': '
                    }
                    if (theme.entity.label_iid == true) {
                        loc_str = loc_str + get_local_iid(d.G_id, theme.entity.iid_shorten)
                    }
                    d.tcolour = theme.entity.tcolour
                    d.tsize = theme.entity.tsize
                    d.split = theme.entity.split_line
                    d.label = loc_str
                    break
                ...
                case 'relation':
                    ...
                    if ((theme.relation.label_name == true) & (theme.relation.label_iid == true)) {
                        loc_str = loc_str + ': '
                    }
                    if (theme.relation.label_iid == true) {
                        loc_str = loc_str + get_local_iid(d.G_id, theme.relation.iid_shorten)
                    }
                    d.tcolour = theme.relation.tcolour
                    d.tsize = theme.relation.tsize
                    d.split = theme.relation.split_line
                    d.label = loc_str
                    break

                case 'super':
                    if (theme.super.label_name == true) {
                        loc_str = loc_str + d.G_name 
                    }
                    if ((theme.super.label_name == true) & (theme.super.label_iid == true)) {
                        loc_str = loc_str + ': '
                    }
                    if (theme.super.label_iid == true) {
                        loc_str = loc_str + get_local_iid(d.G_id, theme.super.iid_shorten)
                    }
                    d.tsize = theme.super.tsize
                    d.split = theme.super.split_line
                    d.label = loc_str
                    break
        ...
        d3cola.on("tick", function () { regularTick(linkmerge, nodemerge, labelmerge, groupmerge, theme.relation.label_offset) });
