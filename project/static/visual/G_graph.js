        ...
        var G_graph = (function () {
            ...
            G_graph.prototype.addCollapsed = function (cgraph) {
                ...
                //this.d3cola.on("tick", null);   
                // change to grouped dataset for nodes and links
                this.edgelist = cgraph.collapsed.links;
            	this.nodelist = cgraph.collapsed.nodes;
                this.grouplist = cgraph.collapsed.groups;
                this.constraintlist = []
            ...
            G_graph.prototype.showGraph = function () {
                ...
                // setup heading colours for attribute, entity, super and relation
                function text_colour(d) {
                    let colour = 'black'
                    switch (d.type) {
                        case 'attribute':
                            if (d.dtype == 'actual'){
                                colour = _this.theme.attribute.tcolour
                            } else {
                                colour = _this.theme.shadow.tcolour
                            }
                            break;            
                        case 'entity':
                            colour = _this.theme.entity.tcolour
                            break;
                        case 'relation':
                            colour = _this.theme.relation.tcolour
                            break;
                        default:
                            colour = 'black'
                            break;
